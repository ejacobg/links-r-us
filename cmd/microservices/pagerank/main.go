...
import (
	"context"
	"fmt"
	"github.com/ejacobg/links-r-us/graph/graphapi"
	"github.com/ejacobg/links-r-us/index/indexapi"
	...
	graphproto "github.com/ejacobg/links-r-us/graph/graphapi/proto"
	indexproto "github.com/ejacobg/links-r-us/index/indexapi/proto"
...
func runMain(appCtx *cli.Context) error {
	...
	var pageRankCfg pagerank.ServiceConfig
...
func getAPIs(ctx context.Context, linkGraphAPI, textIndexerAPI string) (*graphapi.LinkGraphClient, *indexapi.TextIndexerClient, error) {
	if linkGraphAPI == "" {
	...
	graphCli := graphapi.NewLinkGraphClient(ctx, graphproto.NewLinkGraphClient(linkGraphConn))
	...
	indexerCli := indexapi.NewTextIndexerClient(ctx, indexproto.NewTextIndexerClient(indexerConn))
