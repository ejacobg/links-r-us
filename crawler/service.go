...
import (
	...
	"errors"
	"fmt"
	"github.com/ejacobg/links-r-us/crawler/privnet"
...
//go:generate mockgen -package mocks -destination mocks/mocks.go github.com/ejacobg/links-r-us/crawler GraphAPI,IndexAPI
//go:generate mockgen -package mocks -destination mocks/mock_iterator.go github.com/ejacobg/links-r-us/graph LinkIterator
...
// ServiceConfig encapsulates the settings for configuring the web-crawler service.
// Not to be confused with the Config for the crawler itself.
...
func (cfg *ServiceConfig) validate() error {
	...
	if cfg.FetchWorkers <= 0 {
		err = multierror.Append(err, fmt.Errorf("invalid value for fetch workers"))
	}
