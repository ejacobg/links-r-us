...
//go:generate mockgen -package mocks -destination mocks/mocks.go github.com/ejacobg/links-r-us/frontend GraphAPI,IndexAPI
//go:generate mockgen -package mocks -destination mocks/mock_indexer.go github.com/ejacobg/links-r-us/index Iterator
...
func (cfg *Config) validate() error {
	var err error
	if cfg.ListenAddr == "" {
		err = multierror.Append(err, fmt.Errorf("listen address has not been specified"))
	}
